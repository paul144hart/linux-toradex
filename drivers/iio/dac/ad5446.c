			...
			const struct ad5446_chip_info *chip_info)
{
	...
	reg = devm_regulator_get(dev, "fixed-supply");
	if (!IS_ERR(reg)) {
...
//	printk("Value Written to DAC = %x \n ", val);
	status = spi_write(spi, &data, sizeof(data));
return status;
}
...
static const struct spi_device_id ad5446_spi_ids[] = {
	...
	{"ad5662", ID_AD5662},
	{"dac8311", ID_AD5641}, /*kiran bhosale :TI  DAC DAC8311 & ad5641 are compatible*/
	{}
};
