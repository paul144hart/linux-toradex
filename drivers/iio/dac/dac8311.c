/*
 * TI DAC8x11 Digital to Analog Converter SPI driver
 *
 * Copyright (C)
 *
...
#include <linux/of.h>
#define DAC8554_DRIVERNAME			"dac8311"
#define DAC8554_DAC_CHANNELS			1
...
enum dac8x11_Supported_device_ids {
ID_DAC8311,
};
			     ...
			     unsigned val)
{
	u16 data;
	/*
	 * kiran Bhosale : The input shift register is 16 bits wide.The 2 MSBs  are 
	 * power down mode specifiers and 14 LSBs are  data bits
	 */

	if (val > 0xffff && (val & ~DAC8554_PWRDN_TO_SR(3)))
		return -EINVAL;
...
static const struct spi_device_id dac8311_id[] = {
	{"dac8311",ID_DAC8311},
	{}
};
MODULE_DEVICE_TABLE(spi, dac8311_id);
